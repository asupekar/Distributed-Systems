...
class Lab1(object):
    ...
    A simple client that connects to a Group Coordinator Daemon (GCD) which
    responds with a list of potential group members. This client then sends
    a message to each of the group members, prints out their response, and then exits.
    """
    ...
    def join_group(self):
        """
        Does what is specified for Lab 1 -- send a pickled 'JOIN'
    ...
    def meet_members(self):
        """
        Sends a pickled 'HELLO' to all the group members.
        Also verbosely prints out what it is doing.
        """
    ...
    def message(sock, send_data, buffer_size=1024):
        """
        Pickles and sends the given message to the given socket and
        unpickles the returned value and returns it.
